...
const Skeleton = () => {
  ...
  const iconClasses = ["h-4 w-4", "h-6 w-6", "h-8 w-8", "h-6 w-6", "h-4 w-4"];

  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center">
      <div className="flex flex-row flex-shrink-0 justify-center items-center gap-2">
        <Container className={containerClasses[0]}>
          <LuBriefcaseBusiness className={iconClasses[0]} />
        </Container>
        <Container className={containerClasses[1]}>
          <PiGavel className={iconClasses[1]} />
        </Container>
        <Container className={containerClasses[2]}>
          <GoLaw className={iconClasses[2]} />
        </Container>
        <Container className={containerClasses[3]}>
          <IoDocumentsOutline className={iconClasses[3]} />
        </Container>
        <Container className={containerClasses[4]}>
          <MdOutlineDocumentScanner className={iconClasses[4]} />
        </Container>
      </div>
