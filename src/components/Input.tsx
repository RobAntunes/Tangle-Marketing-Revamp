  ...
  return (
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "pl-4 w-full relative text-sm sm:text-base z-50 border-none bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 pr-20",
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              className="text-sm sm:text-base font-light text-neutral-500 pl-4 sm:pl-12 text-left w-[calc(100%-2rem)] truncate"
            >
